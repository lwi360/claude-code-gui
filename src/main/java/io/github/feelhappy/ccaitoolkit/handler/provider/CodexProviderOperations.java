...
public class CodexProviderOperations {
    ...
    public void handleAddCodexProvider(String content) {
        try {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.addCodexFailed", e.getMessage())));
            });
        }
    }
    ...
    public void handleUpdateCodexProvider(String content) {
        try {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.updateCodexFailed", e.getMessage())));
            });
        }
    }
    ...
    public void handleDeleteCodexProvider(String content) {
        ...
        try {
            ...
            if (!data.has("id")) {
                ...
                ApplicationManager.getApplication().invokeLater(() -> {
                    context.callJavaScript("window.showError", context.escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.deleteCodexMissingId")));
                });
                return;
            }
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.deleteCodexFailed", e.getMessage())));
            });
        }
    ...
    public void handleSwitchCodexProvider(String content) {
        try {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showSwitchSuccess", context.escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("toast.providerSwitchSuccess") + io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.switchSyncCodex")));
