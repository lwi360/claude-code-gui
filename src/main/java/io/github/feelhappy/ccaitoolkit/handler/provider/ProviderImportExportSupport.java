package io.github.feelhappy.ccaitoolkit.handler.provider;
...
public class ProviderImportExportSupport {
    ...
    public void handlePreviewCcSwitchImport() {
        ApplicationManager.getApplication().invokeLater(() -> {
            ...
            if (!dbFile.exists()) {
                String errorMsg = io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.ccswitch.notFound", dbFile.getAbsolutePath());
                LOG.error("[ProviderHandler] " + errorMsg);
                sendErrorToFrontend(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.ccswitch.notFoundTitle"), errorMsg);
                return;
            }
            ...
            CompletableFuture.runAsync(() -> {
                try {
                    ...
                    if (providers.isEmpty()) {
                        ...
                        sendInfoToFrontend(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.ccswitch.noDataTitle"), io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.ccswitch.noData"));
                        return;
                    }
                    ...
                    String errorDetails = io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.ccswitch.readFailed") + ": " + e.getMessage();
                    LOG.error("[ProviderHandler] " + errorDetails, e);
                    sendErrorToFrontend(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.ccswitch.readFailedTitle"), errorDetails);
                }
            });
        });
    }
    ...
    public void handleOpenFileChooserForCcSwitch() {
        ApplicationManager.getApplication().invokeLater(() -> {
            try {
                ...
                descriptor.setTitle(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.ccswitch.selectTitle"));
                descriptor.setDescription(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.ccswitch.selectDesc"));
                ...
                if (selectedFiles.length == 0) {
                    ...
                    sendInfoToFrontend(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.ccswitch.cancelledTitle"), io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.ccswitch.cancelled"));
                    return;
                }
                ...
                if (!dbFile.canRead()) {
                    String errorMsg = io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("error.cannotReadFile") + "\n" +
                                              dbFile.getAbsolutePath() + "\n" +
                                              io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("error.checkFilePermissions");
                    LOG.error("[ProviderHandler] " + errorMsg);
                    sendErrorToFrontend(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.ccswitch.permissionErrorTitle"), errorMsg);
                    return;
                }
                ...
                String errorDetails = io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.ccswitch.fileChooserFailed") + ": " + e.getMessage();
                LOG.error("[ProviderHandler] " + errorDetails, e);
                sendErrorToFrontend(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.ccswitch.fileChooserFailedTitle"), errorDetails);
            }
        });
    }
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                ApplicationManager.getApplication().invokeLater(() -> {
                    ...
                    sendInfoToFrontend(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.ccswitch.importSuccessTitle"), io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.ccswitch.importSuccess", count));
                });

            } catch (Exception e) {
                LOG.error("Failed to save imported providers", e);
                sendErrorToFrontend(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.ccswitch.saveFailedTitle"), e.getMessage());
            }
        });
    }
