...
import io.github.feelhappy.ccaitoolkit.model.DeleteResult;
...
public class ClaudeProviderOperations {
    ...
    public void handleAddProvider(String content) {
        try {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.addFailed", e.getMessage())));
            });
        }
    }
    ...
    public void handleUpdateProvider(String content) {
        try {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.updateFailed", e.getMessage())));
            });
        }
    }
    ...
    public void handleDeleteProvider(String content) {
        ...
        try {
            ...
            if (!data.has("id")) {
                ...
                ApplicationManager.getApplication().invokeLater(() -> {
                    context.callJavaScript("window.showError", context.escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.deleteMissingId")));
                });
                return;
            }
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.deleteFailed", e.getMessage())));
            });
        }
        ...
        try {
            ...
            if (DISABLED_PROVIDER_ID.equals(id)) {
                ...
                ApplicationManager.getApplication().invokeLater(() -> {
                    context.callJavaScript("window.showSwitchSuccess",
                            context.escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("toast.providerDisabled")));
                    handleGetProviders();
            ...
            if ("__local_settings_json__".equals(id)) {
                ...
                if (!Files.exists(settingsPath)) {
                    ...
                    ApplicationManager.getApplication().invokeLater(() -> {
                        context.callJavaScript("window.showError",
                                context.escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("error.localProviderSettingsNotFound")));
                    });
                    return;
                }
                ...
                try {
                    ...
                    ApplicationManager.getApplication().invokeLater(() -> {
                        context.callJavaScript("window.showError",
                                context.escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("error.localProviderInvalidJson", e.getMessage())));
                    });
                    return;
                }
                ...
                ApplicationManager.getApplication().invokeLater(() -> {
                    context.callJavaScript("window.showSwitchSuccess",
                            context.escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("toast.localProviderSwitchSuccess")));
                    handleGetProviders();
                    handleGetActiveProvider();
                });
                return;
            ...
            if ("__cli_login__".equals(id)) {
                ...
                ApplicationManager.getApplication().invokeLater(() -> {
                    context.callJavaScript("window.showSwitchSuccess",
                            context.escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("toast.cliLoginSwitchSuccess")));
                    handleGetProviders();
                    handleGetActiveProvider();
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showSwitchSuccess", context.escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("toast.providerSwitchSuccess") + io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("provider.switchSyncClaude")));
                handleGetProviders();
                handleGetActiveProvider();
            });
        } catch (Exception e) {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("toast.providerSwitchFailed") + ": " + e.getMessage()));
            });
        }
    }
