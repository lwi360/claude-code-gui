...
import io.github.feelhappy.ccaitoolkit.handler.UsagePushService;
import io.github.feelhappy.ccaitoolkit.handler.core.HandlerContext;

import io.github.feelhappy.ccaitoolkit.skill.SlashCommandRegistry;
...
public class ModelProviderHandler {
    ...
    public void handleSetModel(String content) {
        try {
            ...
            io.github.feelhappy.ccaitoolkit.notifications.ClaudeNotifier.setModel(context.getProject(), model);
