...
public class PermissionHandler extends BaseMessageHandler {
    ...
    public void showPermissionDialog(PermissionRequest request) {
        ...
        try {
            ...
            io.github.feelhappy.ccaitoolkit.ui.toolwindow.ClaudeChatWindow targetWindow =
                io.github.feelhappy.ccaitoolkit.ui.toolwindow.ClaudeSDKToolWindow.getChatWindow(targetProject);
