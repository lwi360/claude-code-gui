package io.github.feelhappy.ccaitoolkit.handler.context;
        ...
        if (JAVA_PLUGIN_AVAILABLE) {
            try {
                Class<?> javaCollectorClass = Class.forName(
                    "io.github.feelhappy.ccaitoolkit.handler.context.JavaContextCollector");
        ...
        if (PYTHON_PLUGIN_AVAILABLE) {
            try {
                Class<?> pythonCollectorClass = Class.forName(
                    "io.github.feelhappy.ccaitoolkit.handler.context.PythonContextCollector");
