...
import io.github.feelhappy.ccaitoolkit.model.ConflictStrategy;
        ...
        try {
            ...
            if (agentId != null) {
                ...
                if (agent != null) {
                    ...
                    io.github.feelhappy.ccaitoolkit.notifications.ClaudeNotifier.setAgent(context.getProject(), agentName);
                } else {
                    io.github.feelhappy.ccaitoolkit.notifications.ClaudeNotifier.setAgent(context.getProject(), "");
                }
            } else {
                io.github.feelhappy.ccaitoolkit.notifications.ClaudeNotifier.setAgent(context.getProject(), "");
            }
            ...
            try {
                ...
                if (selectedDir != null && selectedFile != null) {
                    ...
                    try (FileWriter writer = new FileWriter(fileToSave, StandardCharsets.UTF_8)) {
                        ...
                        io.github.feelhappy.ccaitoolkit.notifications.ClaudeNotifier.showSuccess(
                                context.getProject(),
                ...
                io.github.feelhappy.ccaitoolkit.notifications.ClaudeNotifier.showError(
                        context.getProject(),
