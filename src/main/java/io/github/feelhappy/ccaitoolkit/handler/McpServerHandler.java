...
public class McpServerHandler extends BaseMessageHandler {
    ...
    private void handleAddMcpServer(String content) {
        try {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                String errorMsg = escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("mcp.addServerFailedWithReason", e.getMessage()));
    ...
    private void handleUpdateMcpServer(String content) {
        try {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                String errorMsg = escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("mcp.updateServerFailedWithReason", e.getMessage()));
                callJavaScript("window.showError", errorMsg);
            });
        }
    }
    ...
    private void handleDeleteMcpServer(String content) {
        try {
            ...
            if (success) {
                ...
                ApplicationManager.getApplication().invokeLater(() -> {
                    String errorMsg = escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("mcp.deleteServerFailedWithReason", io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("mcp.serverNotFound")));
                    callJavaScript("window.showError", errorMsg);
                });
            }
        } catch (Exception e) {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                String errorMsg = escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("mcp.deleteServerFailedWithReason", e.getMessage()));
                callJavaScript("window.showError", errorMsg);
            });
        }
    }
