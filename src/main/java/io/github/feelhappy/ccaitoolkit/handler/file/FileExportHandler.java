package io.github.feelhappy.ccaitoolkit.handler.file;
...
public class FileExportHandler extends BaseMessageHandler {
    ...
    public boolean handle(String type, String content) {
        if ("save_markdown".equals(type)) {
            ...
            handleSaveFile(content, ".md", io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("file.saveMarkdownDialog"));
            return true;
        } else if ("save_json".equals(type)) {
            LOG.info("[FileExportHandler] 处理: save_json");
            handleSaveFile(content, ".json", io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("file.saveJsonDialog"));
            return true;
        }
        return false;
    }
    ...
    private void writeFileAsync(File fileToSave, String content) {
        CompletableFuture.runAsync(() -> {
            try (FileWriter writer = new FileWriter(fileToSave, StandardCharsets.UTF_8)) {
                ...
                notifySuccess(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("file.saved"));
            } catch (IOException e) {
                LOG.error("[FileExportHandler] 保存文件失败: " + e.getMessage(), e);
                String errorDetail = e.getMessage() != null ? e.getMessage() : io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("file.saveFailed");
                notifyError(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("file.saveFailedWithReason", errorDetail));
            }
        });
    }
    ...
    private void notifyError(String message) {
        ApplicationManager.getApplication().invokeLater(() -> {
            String errorDetail = message != null ? message : io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("file.unknownError");
            String errorMsg = escapeJs(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("file.saveFailedWithReason", errorDetail));
            String jsCode = "if (window.addToast) { " +
