...
import io.github.feelhappy.ccaitoolkit.settings.TabStateService;
import io.github.feelhappy.ccaitoolkit.startup.BridgePreloader;
import io.github.feelhappy.ccaitoolkit.ui.detached.DetachedWindowManager;
...
public class ClaudeSDKToolWindow implements ToolWindowFactory, DumbAware {
    ...
    public void createToolWindowContent(@NotNull Project project, @NotNull ToolWindow toolWindow) {
        ...
        if (PlatformUtils.isPluginDevMode()) {
            com.intellij.openapi.actionSystem.AnAction devToolsAction =
                    com.intellij.openapi.actionSystem.ActionManager.getInstance()
                            .getAction("CcAiToolkit.OpenDevToolsAction");
        ...
        com.intellij.openapi.actionSystem.AnAction renameTabAction =
                com.intellij.openapi.actionSystem.ActionManager.getInstance()
                        .getAction("CcAiToolkit.RenameTabAction");
        com.intellij.openapi.actionSystem.AnAction detachTabAction =
                com.intellij.openapi.actionSystem.ActionManager.getInstance()
                        .getAction("CcAiToolkit.DetachTabAction");
    ...
    private JPanel createLoadingPanel() {
        ...
        panel.setBackground(io.github.feelhappy.ccaitoolkit.util.ThemeConfigService.getBackgroundColor());
