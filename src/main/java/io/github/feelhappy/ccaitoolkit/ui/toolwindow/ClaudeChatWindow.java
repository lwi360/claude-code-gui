package io.github.feelhappy.ccaitoolkit.ui.toolwindow;

import io.github.feelhappy.ccaitoolkit.action.SendShortcutSync;
...
import io.github.feelhappy.ccaitoolkit.session.SessionCallbackAdapter;
import io.github.feelhappy.ccaitoolkit.session.SessionLifecycleManager;
import io.github.feelhappy.ccaitoolkit.session.SessionLoadService;
...
import io.github.feelhappy.ccaitoolkit.ui.ChatWindowDelegate;
import io.github.feelhappy.ccaitoolkit.ui.EditorContextTracker;
import io.github.feelhappy.ccaitoolkit.ui.WebviewInitializer;
import io.github.feelhappy.ccaitoolkit.ui.WebviewWatchdog;
import io.github.feelhappy.ccaitoolkit.util.HtmlLoader;
...
public class ClaudeChatWindow {
    ...
    public ClaudeChatWindow(Project project, boolean skipRegister) {
        ...
        this.mainPanel.setBackground(io.github.feelhappy.ccaitoolkit.util.ThemeConfigService.getBackgroundColor());
    ...
    private void showInitializingPlaceholder() {
        ...
        placeholder.setBackground(io.github.feelhappy.ccaitoolkit.util.ThemeConfigService.getBackgroundColor());
        ...
        JLabel label = new JLabel(
                io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("toolwindow.initializingUI"));
    ...
    private void interruptDueToPermissionDenial() {
        this.session.interrupt().thenRun(() -> ApplicationManager.getApplication().invokeLater(() -> {
            ...
            io.github.feelhappy.ccaitoolkit.notifications.ClaudeNotifier.clearStatus(project);
        }));
    }
