...
public class ErrorPanelBuilder {
    ...
    public static JPanel build(String title, String message, String currentNodePath, Consumer<String> onSaveAndRetry) {
        ...
        JLabel nodeLabel = new JLabel(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("error.nodePathLabel"));
        ...
        JButton saveAndRetryButton = new JButton(io.github.feelhappy.ccaitoolkit.i18n.ClaudeCodeGuiBundle.message("error.saveButton"));
