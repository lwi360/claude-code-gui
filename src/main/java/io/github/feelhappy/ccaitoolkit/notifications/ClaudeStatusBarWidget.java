...
public class ClaudeStatusBarWidget implements CustomStatusBarWidget, StatusBarWidget, Disposable {
    ...
    public @NotNull String ID() {
        return PluginIds.STATUS_BAR_WIDGET_ID;
    }
        ...
        if (label == null) {
            ...
            label.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    var toolWindow = ToolWindowManager.getInstance(project).getToolWindow(PluginIds.TOOL_WINDOW_ID);
                    if (toolWindow != null) {
    ...
    public static class Factory implements StatusBarWidgetFactory {
        ...
        public static ClaudeStatusBarWidget getWidget(@NotNull Project project) {
            ...
            if (statusBar != null) {
                StatusBarWidget widget = statusBar.getWidget(PluginIds.STATUS_BAR_WIDGET_ID);
