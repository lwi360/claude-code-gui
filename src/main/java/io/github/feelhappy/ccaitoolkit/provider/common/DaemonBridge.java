package io.github.feelhappy.ccaitoolkit.provider.common;
...
public class DaemonBridge {
    ...
    /**
     * Determine whether the daemon should be treated as unresponsive.
     * When active requests are in progress, use an extended timeout to avoid
     * killing the daemon during long-running operations (e.g., large file edits).
     */
